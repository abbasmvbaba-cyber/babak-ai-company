...
full_name: بهنام قاسمی
department: بازاریابی
role: کارشناس روابط عمومی
gender: مرد
age_bucket: ۲۰ تا ۲۴ سال
synthetic_demo: true
---

# پرونده پرسنلی بهنام قاسمی
...
| فیلد | مقدار |
|---|---|
| نام و نام خانوادگی | بهنام قاسمی |
| جنسیت | مرد |
| تاریخ تولد | 1381/10/13 |
| سن در تاریخ 1405/06/12 | 23 سال |
| نام پدر | ناصر |
| کد ملی نمایشی | IR-DEMO-000017 |
| محل تولد | تهران |
| تابعیت | ایرانی |
...
| تاریخ استخدام | 1401/04/12 |
| سابقه تقریبی در شرکت | 4 سال |
| نوع همکاری | تمام‌وقت — دادهٔ نمونه |
| وضعیت | فعال — نمونه |
| ایمیل سازمانی نمونه | employee017@babak-ai.company |
| داخلی نمونه | 1017 |
...
|---|---|---|---|---|---|
| دیپلم | علوم تجربی | دبیرستان نمونه ایرانیان | 1396/07/01 | 1399/03/15 | اخذ شده |
